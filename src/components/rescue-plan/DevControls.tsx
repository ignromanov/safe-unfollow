...
export function DevControls({ segment, onCycle }: DevControlsProps) {
  ...
  return (
    <button
      onClick={onCycle}
      className="absolute top-4 start-4 p-2 text-zinc-400 hover:text-primary-strong transition-colors rounded-full hover:bg-black/5 dark:hover:bg-white/5 flex items-center gap-1 text-xs font-mono z-10"
