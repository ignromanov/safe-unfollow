 ...
 * that keeps listing them advertises a redirect chain as a destination.
 *
...
describe.runIf(built)('sitemap after the wizard routes were removed', () => {
  ...
  // nine of the ten sets of redirects pointed at pages Google had never been asked to crawl.
  const uploadUrl = (lang: string) =>
    lang === 'en' ? 'https://safeunfollow.app/upload' : `https://safeunfollow.app/${lang}/upload`;

  it.each(SUPPORTED_LANGUAGES)(
    "still lists the %s /upload, which is where that locale's redirects land",
    lang => {
