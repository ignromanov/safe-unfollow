 ...
 *   (wizardStepView, filterToggle, searchPerform and guideEntryView were unsampled
 *   again on 2026-08-21 — GH#123; webVital keeps its 3%. Every one of those four
 *   series steps by 20x or 33x on that deploy date)
